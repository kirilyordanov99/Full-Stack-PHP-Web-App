...
@section('content')
    <form method="post" action="/brands">
        ...
        <div class="col-md-2 ml-2 mt-3">
            ...
            <input type="number" class="form-control {{$errors->has('year_of_creation') ? 'border-danger' : ''}}" name="year_of_creation" placeholder="Year of creation" value = "{{old('year_of_creation')}}" required>
            </div>
